...
- WebGUI does not work on iOS in Chrome or Safari because they do not support Web Bluetooth API on the device level for browsers. To have the GUI working, a special browser supporting the Web Bluetooth API like [Bluefy](https://apps.apple.com/us/app/bluefy-web-ble-browser/id1492822055) is necessary (note, workout export does not work which is a known issue)
