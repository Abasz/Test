    ...
    // TypeScript files configuration
    {
        ...
        languageOptions: {
            globals: {
                ...
                BluetoothAdvertisingData: "readonly",
                BluetoothManufacturerData: "readonly",
                BluetoothServiceData: "readonly",
                ...
                USBDeviceRequestOptions: "readonly",
                USBControlTransferParameters: "readonly",
            },
