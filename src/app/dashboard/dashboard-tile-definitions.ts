...
export const DEFAULT_PORTRAIT_LAYOUT: IDashboardLayoutConfig = {
    tiles: [
        ...
        { id: "distPerStroke", position: { rowStart: 2, columnStart: 3, rowSpan: 1, columnSpan: 1 } },
        { id: "forceCurve", position: { rowStart: 3, columnStart: 1, rowSpan: 2, columnSpan: 1 } },
        { id: "totalStrokes", position: { rowStart: 3, columnStart: 1, rowSpan: 1, columnSpan: 1 } },
        { id: "dragFactor", position: { rowStart: 3, columnStart: 3, rowSpan: 1, columnSpan: 1 } },
        { id: "driveTime", position: { rowStart: 4, columnStart: 1, rowSpan: 1, columnSpan: 1 } },
