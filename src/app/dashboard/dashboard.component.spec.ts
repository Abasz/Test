...
describe("DashboardComponent", (): void => {
    ...
    describe("elapseTime signal", (): void => {
        ...
        describe("when erg connects", (): void => {
            ...
            it("should start calculating elapsed time from activity start", (): void => {
    ...
    describe("ngAfterViewInit method", (): void => {
        ...
        describe("when in production mode", (): void => {
            ...
            describe("and update check fails", (): void => {
                beforeEach((): void => {
                    swUpdateSpy.checkForUpdate.and.returnValue(Promise.reject(new Error("Update failed")));
                    spyOn(console, "error");
                });
        ...
        describe("storage persistence", (): void => {
            ...
            describe("when StorageManager API is available", (): void => {
                describe("and storage is already persisted", (): void => {
                    beforeEach((): void => {
                        mockStorage.persisted.and.returnValue(Promise.resolve(true));
                    });
                ...
                describe("and storage is not persisted", (): void => {
                    beforeEach((): void => {
                        mockStorage.persisted.and.returnValue(Promise.resolve(false));
                    });

                    describe("and persist request succeeds", (): void => {
                        beforeEach((): void => {
                            mockStorage.persist.and.returnValue(Promise.resolve(true));
                        });
                    ...
                    describe("and persist request fails", (): void => {
                        beforeEach((): void => {
                            mockStorage.persist.and.returnValue(Promise.resolve(false));
                            spyOn(console, "warn");
                        });
                    ...
                    describe("and persist request throws error", (): void => {
                        ...
                        beforeEach((): void => {
                            mockStorage.persist.and.returnValue(Promise.reject(persistError));
                        });
                ...
                describe("and checking persistence throws error", (): void => {
                    ...
                    beforeEach((): void => {
                        mockStorage.persisted.and.returnValue(Promise.reject(persistedCheckError));
                    });
        ...
        describe("Bluetooth API availability", (): void => {
            let isSecureContextSpy: jasmine.Spy;
            let navigatorBluetoothSpy: jasmine.Spy;
