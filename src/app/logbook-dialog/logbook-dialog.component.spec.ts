...
describe("LogbookDialogComponent", (): void => {
    ...
    beforeEach(async (): Promise<void> => {
        ...
        dataRecorderSpy.deleteSession.and.returnValue(Promise.resolve([1, 1, 1, 1]));
    ...
    describe("template", (): void => {
        ...
        it("should update table rows when getSessionSummaries$ emits", (): void => {
            summaries$.next([]);
            fixture.detectChanges();
            expect(fixture.nativeElement.querySelectorAll("mat-row").length).toBe(0);
    ...
    describe("exportToJson method", (): void => {
        it("should call respective service method with the given sessionId", async (): Promise<void> => {
            // arrange
            summaries$.next(SESSIONS);
            dataRecorderSpy.exportSessionToJson.and.returnValue(Promise.resolve());
            fixture.detectChanges();
    ...
    describe("exportToTcx method", (): void => {
        it("should call respective service method with the given sessionId", async (): Promise<void> => {
            // arrange
            summaries$.next(SESSIONS);
            dataRecorderSpy.exportSessionToTcx.and.returnValue(Promise.resolve());
            fixture.detectChanges();
        ...
        it("shows snackbar on exportToTcx error", async (): Promise<void> => {
            // arrange
            summaries$.next(SESSIONS);
            dataRecorderSpy.exportSessionToTcx.and.returnValue(Promise.reject(new Error("export tcx error")));
            fixture.detectChanges();
    ...
    describe("deleteSession method", (): void => {
        ...
        it("should show error snackbar if deletion fails", async (): Promise<void> => {
            summaries$.next(SESSIONS);
            fixture.detectChanges();
            dataRecorderSpy.deleteSession.and.returnValue(Promise.reject(new Error("Delete failed")));
    ...
    describe("export method", (): void => {
        ...
        describe("on export error", (): void => {
            it("should show failure snackbar", async (): Promise<void> => {
                dataRecorderSpy.export.and.returnValue(Promise.reject(new Error("Export failed")));
                fixture.detectChanges();
    ...
    describe("import method", (): void => {
        ...
        describe("on import error", (): void => {
            it("should show failure snackbar", async (): Promise<void> => {
                const mockFile = new File(["test content"], "test.csv", { type: "text/csv" });
                dataRecorderSpy.import.and.returnValue(Promise.reject(new Error("Import failed")));
                fixture.detectChanges();
