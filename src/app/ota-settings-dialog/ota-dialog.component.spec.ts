...
describe("OtaDialogComponent", (): void => {
    ...
    beforeEach(async (): Promise<void> => {
        ...
        mockOtaService.performOta.and.returnValue(Promise.resolve());
        mockOtaService.abortOta.and.returnValue(Promise.resolve());
    ...
    describe("cancelUpdate method", (): void => {
        ...
        it("should handle OtaError during abort", async (): Promise<void> => {
            ...
            mockOtaService.abortOta.and.returnValue(Promise.reject(otaError));
        ...
        it("should handle generic error during abort", async (): Promise<void> => {
            ...
            mockOtaService.abortOta.and.returnValue(Promise.reject(genericError));
            spyOn(console, "error");
    ...
    describe("initOta method", (): void => {
        ...
        it("should handle OtaError during initialization", async (): Promise<void> => {
            ...
            mockOtaService.performOta.and.returnValue(Promise.reject(otaError));
        ...
        it("should handle generic error during initialization", async (): Promise<void> => {
            const genericError = new Error("Generic error");
            mockOtaService.performOta.and.returnValue(Promise.reject(genericError));
            spyOn(console, "error");
