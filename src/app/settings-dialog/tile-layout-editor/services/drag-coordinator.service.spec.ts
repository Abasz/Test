...
describe("DragCoordinator", (): void => {
    ...
    describe("startTileDrag method", (): void => {
        ...
        it("should create drag preview when source element is provided", (): void => {
            ...
            coordinator.startTileDrag(createPointer(50, 30, el), placedTile);

            expect(mockPreview.create).toHaveBeenCalledWith(el, 50, 30, "6px", gridContainer);
        });
        ...
        it("should calculate grab offset from source element", (): void => {
            ...
            coordinator.startTileDrag(createPointer(150, 24, el), wideTile);
    ...
    describe("startPaletteDrag method", (): void => {
        ...
        it("should create drag preview in palette container when source element is provided", (): void => {
            ...
            coordinator.startPaletteDrag(createPointer(50, 40, el), tileDefinition);

            expect(mockPreview.create).toHaveBeenCalledWith(el, 50, 40, "16px", paletteContainer);
        });
    });
