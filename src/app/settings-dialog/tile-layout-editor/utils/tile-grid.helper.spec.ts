...
describe("TileGridHelper", (): void => {
    ...
    describe("areTilePositionsEqual method", (): void => {
        it("should return true for identical positions", (): void => {
            const a: TilePosition = { rowStart: 1, columnStart: 2, rowSpan: 3, columnSpan: 4 };
            const b: TilePosition = { rowStart: 1, columnStart: 2, rowSpan: 3, columnSpan: 4 };

            expect(TileGridHelper.areTilePositionsEqual(a, b)).toBe(true);
        });

        it("should return false when rowStart differs", (): void => {
            const a: TilePosition = { rowStart: 1, columnStart: 2, rowSpan: 1, columnSpan: 1 };
            const b: TilePosition = { rowStart: 2, columnStart: 2, rowSpan: 1, columnSpan: 1 };

            expect(TileGridHelper.areTilePositionsEqual(a, b)).toBe(false);
        });

        it("should return false when columnStart differs", (): void => {
            const a: TilePosition = { rowStart: 1, columnStart: 1, rowSpan: 1, columnSpan: 1 };
            const b: TilePosition = { rowStart: 1, columnStart: 2, rowSpan: 1, columnSpan: 1 };
        ...
        it("should return false when rowSpan differs", (): void => {
            const a: TilePosition = { rowStart: 1, columnStart: 1, rowSpan: 1, columnSpan: 1 };
            const b: TilePosition = { rowStart: 1, columnStart: 1, rowSpan: 2, columnSpan: 1 };

            expect(TileGridHelper.areTilePositionsEqual(a, b)).toBe(false);
        });

        it("should return false when columnSpan differs", (): void => {
            const a: TilePosition = { rowStart: 1, columnStart: 1, rowSpan: 1, columnSpan: 1 };
            const b: TilePosition = { rowStart: 1, columnStart: 1, rowSpan: 1, columnSpan: 2 };
    ...
    describe("calculateGrabOffset method", (): void => {
        ...
        it("should return undefined offsets when element has zero dimensions", (): void => {
            ...
            const result = TileGridHelper.calculateGrabOffset(el, 100, 100, {
                rowStart: 1,
                columnStart: 1,
                rowSpan: 1,
                columnSpan: 1,
        ...
        it("should return zero offsets when clicking top-left of a 1x1 tile", (): void => {
            ...
            const result = TileGridHelper.calculateGrabOffset(el, 100, 50, {
                rowStart: 1,
                columnStart: 1,
                rowSpan: 1,
                columnSpan: 1,
        ...
        it("should calculate correct offset for a 2x3 tile clicked in the middle", (): void => {
            ...
            const result = TileGridHelper.calculateGrabOffset(el, 150, 100, {
                rowStart: 1,
                columnStart: 1,
                rowSpan: 2,
                columnSpan: 3,
