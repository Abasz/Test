...
import { AntFeService } from "./ant-fe/ant-fe.service";
...
export class MetricsService {
    ...
    constructor(
        private antFeService: AntFeService,
    ...
    private setupMetricStream$(): Observable<ICalculatedMetrics> {
        return combineLatest([
            ...
            tap((calculatedMetrics: ICalculatedMetrics): void =>
                this.antFeService.notifyMetrics(calculatedMetrics),
            ),
        );
    }
