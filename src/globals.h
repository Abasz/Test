...
static constexpr unsigned long msecsPerSec = 1'000'000;
static constexpr unsigned long secsPerMin = 60;
static constexpr unsigned long secsPerHour = 3'600;
static constexpr unsigned long secsPerDay = 86'400;
