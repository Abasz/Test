...
import { CalibrationComponent } from "./app/calibration/calibration.component";
...
bootstrapApplication(AppComponent, {
    providers: [
        provideRouter([
            {
                path: "calibration",
                loadComponent: async (): Promise<typeof CalibrationComponent> =>
                    (await import("./app/calibration/calibration.component")).CalibrationComponent,
            },
            {
                path: "",
