...
{
    RequestControlFtms = 0U,
    SetCumulativeValue = 1U, // Reset in FTMS
    UpdateSensorLocation = 2U,
    RequestSupportedSensorLocations = 3U,
    SetCrankLength = 4U,
    RequestCrankLength = 5U,
    SetChainLength = 6U,
    RequestChainLength = 7U, // Start or Resume in FTMS
    SetChainWeight = 8U,     // Stop or Pause in FTMS
...
{
public:
    SensorLocations() = delete;

    static constexpr unsigned char Other = 0U;
    static constexpr unsigned char TopOfShoe = 1U;
    static constexpr unsigned char InShoe = 2U;
    static constexpr unsigned char Hip = 3U;
    static constexpr unsigned char FrontWheel = 4U;
    static constexpr unsigned char LeftCrank = 5U;
    static constexpr unsigned char RightCrank = 6U;
    static constexpr unsigned char LeftPedal = 7U;
    static constexpr unsigned char RightPedal = 8U;
    static constexpr unsigned char FrontHub = 9U;
    static constexpr unsigned char RearDropout = 10U;
    static constexpr unsigned char Chainstay = 11U;
    static constexpr unsigned char RearWheel = 12U;
    static constexpr unsigned char RearHub = 13U;
    static constexpr unsigned char Chest = 14U;
    static constexpr unsigned char Spider = 15U;
    static constexpr unsigned char ChainRing = 16U;
};

class CSCFeaturesFlags
{
public:
    CSCFeaturesFlags() = delete;
...
{
public:
    PSCMeasurementFeaturesFlags() = delete;
...
{
public:
    FTMSMeasurementFeaturesFlags() = delete;
...
public:
    ...
    static constexpr unsigned char ftmsStatusStopped = 0x02U;
    static constexpr unsigned char ftmsStatusStarted = 0x04U;
    ...
    static constexpr unsigned short ftmsStatusUuid = 0x2ADA;
};

class CommonBleFlags
{
public:
    CommonBleFlags() = delete;
    ...
    static constexpr std::string_view settingsServiceUuid = "56892de1-7068-4b5a-acaa-473d97b02206";
    static constexpr std::string_view settingsUuid = "54e15528-73b5-4905-9481-89e5184a3364";
    static constexpr std::string_view strokeDetectionSettingsUuid = "5d9c04cd-dcec-4551-8169-8c81f14d9d9d";
    static constexpr std::string_view settingsControlPointUuid = "51ba0a00-8853-477c-bf43-6a09c36aac9f";

    static constexpr std::string_view extendedMetricsServiceUuid = "a72a5762-803b-421d-a759-f0314153da97";
    static constexpr std::string_view extendedMetricsUuid = "808a0d51-efae-4f0c-b2e0-48bc180d65c3";
    static constexpr std::string_view handleForcesUuid = "3d9c2760-cf91-41ee-87e9-fd99d5f129a4";
    static constexpr std::string_view deltaTimesUuid = "ae5d11ea-62f6-4789-b809-6fc93fee92b9";

    static constexpr std::string_view otaServiceUuid = "ed249319-32c3-4e9f-83d7-7bb5aa5d5d4b";
    static constexpr std::string_view otaRxUuid = "fbac1540-698b-40ff-a34e-f39e5b78d1cf";
    static constexpr std::string_view otaTxUuid = "b31126a7-a29b-450a-b0c2-c0516f46b699";
