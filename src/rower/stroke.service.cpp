...
void StrokeService::recoveryEnd()
{
    ...
    // CSV format: [CYCLIC],STROKE_END,strokeCount,recoveryGoF,recoveryDuration
    printf("[CYCLIC],STROKE_END,%u,%.6f,%.0f\n", strokeCount, goodnessOfFit, static_cast<double>(recoveryDuration));
