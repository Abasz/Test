...
const std::array<unsigned long, 4> deltaTimes = {
    ...
    SECTION("processRotation method")
    {
        ...
        SECTION("should update data based on new valid measurement")
        {
            RowingDataModels::FlywheelData expected{
                ...
                .totalAngularDisplacement = (2 * PI) / RowerProfile::Defaults::impulsesPerRevolution * static_cast<double>(deltaTimes.size()),
